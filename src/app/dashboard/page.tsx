...
const DashboardPage = () => {
  ...
  const loadBookings = async () => {
    try {
      ...
      // For now, start with empty bookings - no fake data
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input value={user?.profile?.firstName || ''} disabled />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">Last Name</label>
                          <Input value={user?.profile?.lastName || ''} disabled />
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <Input value={user?.profile?.phone || '+1 (555) 123-4567'} disabled />
                        </div>
                      </div>
